...
describe("fs.createReadStream", function() {
  ...
  describe("encoding", function() {
    ...
    it("_write() receives Buffer (not string !?), even with options.encoding specified, ", function(done) {
    ...
    it("if options is a string, then it specifies the encoding", function(done) {
    ...
    it("reading windows1250 with latin1 will not produce excpected result", function(done) {
      // https://nodejs.org/api/buffer.html#buffer_buffers_and_character_encodings
      // The character encodings currently supported by Node.js include:
    ...
    it("piping windows1250 file to Iconv stream", function(done) {
      // https://nodejs.org/api/buffer.html#buffer_buffers_and_character_encodings
      // The character encodings currently supported by Node.js include:
    ...
    it("piping windows1250 file to custome Transform()", function(done) {
    ...
    it("become improperly decoded if simply pulled from the stream as Buffer objects", function(done) {
    ...
    it.skip("pattern:piping Readable stream to Transform", function(done) {
